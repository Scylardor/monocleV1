/*
    ...
    WGL loader generated by glad 0.1.14a0 on Tue May 23 07:16:02 2017.
...
HGLRC APIENTRY glad_debug_impl_wglGetCurrentAssociatedContextAMD() {    
    HGLRC ret;
...
HDC APIENTRY glad_debug_impl_wglGetCurrentReadDCARB() {    
    HDC ret;
...
const char * APIENTRY glad_debug_impl_wglGetExtensionsStringEXT() {    
    const char * ret;
...
HDC APIENTRY glad_debug_impl_wglGetCurrentReadDCEXT() {    
    HDC ret;
...
int APIENTRY glad_debug_impl_wglGetSwapIntervalEXT() {    
    int ret;
...
BOOL APIENTRY glad_debug_impl_wglEnableFrameLockI3D() {    
    BOOL ret;
...
BOOL APIENTRY glad_debug_impl_wglDisableFrameLockI3D() {    
    BOOL ret;
...
BOOL APIENTRY glad_debug_impl_wglBeginFrameTrackingI3D() {    
    BOOL ret;
...
BOOL APIENTRY glad_debug_impl_wglEndFrameTrackingI3D() {    
    BOOL ret;
